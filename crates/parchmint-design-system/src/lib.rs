//! Framework-neutral UI tokens and symbolic SVG icons.

mod tokens;

pub use tokens::{DesignToken, REQUIRED_SEMANTIC_ROLES, TOKENS};

/// Returns a checked-in production token record by semantic role.
pub fn production_token(name: &str) -> Option<&'static DesignToken> {
...
///
/// The path is the component geometry, normalized to its
...
/// The 20 px Project vector for the `WorkspaceTopBar` component.
...
/// The 20 px Editor vector for the `WorkspaceTopBar` component.
...
/// The 20 px Cards vector for the `WorkspaceTopBar` component.
...
/// The 20 px History vector for the `WorkspaceTopBar` component.
...
/// The 20 px Recently Deleted vector for the `WorkspaceTopBar` component.
...
/// The 20 px Export vector for the `WorkspaceTopBar` component.
...
/// The 20 px Settings vector for the `WorkspaceTopBar` component.
...
/// The 18 px bulleted-list vector for the `FormattingToolbar` component.
...
/// The 20 px block-quote vector for the `FormattingToolbar` component.
...
/// The 20 px link vector for the `FormattingToolbar` component.
