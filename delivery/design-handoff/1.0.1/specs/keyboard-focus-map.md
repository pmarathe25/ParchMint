...
| Export dialog | Export summary or error summary first | Progress and completion announced politely; native file handoff documented |
...
- `pm.a11y` notes recorded on search (polite announcements, predictable focus
  ...
  export (initial focus export-summary/error, progress and completion announcements).
