...
- Project hierarchy: Manuscript → Chapter One (primary) and Research →
  Source Notes (companion).
- Pane/tab state: two panes; primary shows a Manuscript document, companion a
  Research document (`editor-dual-two-manuscript` equivalent); each tab strip
  present.
