...
S50 must not implement any rejected variant from ISSUE-001 through ISSUE-005, persistent project mutation, native dialog behavior, history/search/spellcheck adapters, or the editor's shared-state mechanism.
...
| S65 spellcheck | SPELL-001–006, DictionarySettings, underline/menu | S60 editor contract, S40 preferences | three-platform native spelling/latency; enforce resolved ISSUE-004 guardrail |
| S70 history/deletion | HIST-001–010, DEL-001–007, PM history/deletion family | S40 HistoryStore | Tier A/B, recovery/history fault checks; enforce resolved ISSUE-003 guardrail |
| S80 search | SEARCH-001–014, GlobalSearchPanel/ReplacePreview | S40 SearchIndex | Tier A/B indexing/replace checks; enforce resolved ISSUE-001 guardrail |
