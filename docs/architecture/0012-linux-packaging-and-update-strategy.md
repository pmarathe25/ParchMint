...
Status: Accepted (Stage 09 engineering scope)
...
These choices authorize engineering packages, not distribution. Publishing any
artifact remains blocked by ADR-0001 and proposed ADR-0013 until the user selects
a distribution license and the release environment authorizes publication.
