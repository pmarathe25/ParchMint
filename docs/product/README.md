...
- [Launcher and project creation](features/launcher-and-project-creation.md)
- [Workspace shell](features/workspace-shell.md)
- [Appearance](features/appearance.md)
- [Explorer and hierarchy](features/explorer-and-hierarchy.md)
- [Editor panes and tabs](features/editor-panes-and-tabs.md)
- [Rich text and semantic styles](features/rich-text-and-semantic-styles.md)
- [Formatting toolbar](features/formatting-toolbar.md)
- [Titles](features/titles.md)
- [Synopsis and metadata](features/synopsis-and-metadata.md)
- [Comments and annotations](features/comments-and-annotations.md)
- [Cards](features/cards.md)
- [Search and replacement](features/search-and-replacement.md)
- [Undo and redo](features/undo-and-redo.md)
- [Save, recovery, and closing](features/save-recovery-and-closing.md)
- [History and snapshots](features/history-and-snapshots.md)
- [Deletion and Recently Deleted](features/deletion-and-recently-deleted.md)
- [Research](features/research.md)
- [Word counts](features/word-counts.md)
- [Spellcheck](features/spellcheck.md)
