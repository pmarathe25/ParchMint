...
- **SEC-005:** Project and auxiliary-storage path validation rejects symlink or reparse escapes. Pasted HTML is sanitized.
...
- **SEC-009:** Local diagnostics contain only safe operational fields, never document prose, and use bounded retention.
