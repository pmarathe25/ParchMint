...
ToolBar {
    ...
    RowLayout {
        ...
        ToolButton {
            text: qsTr("Center")
            enabled: root.adapter.focused
            Accessible.name: qsTr("Center paragraph")
        ...
        ToolButton {
            text: qsTr("Image…")
            enabled: root.adapter.focused
            Accessible.name: qsTr("Insert local image asset")
    ...
    Dialog {
        id: imageDialog
        title: qsTr("Insert local image asset")
        modal: true
        standardButtons: Dialog.Ok | Dialog.Cancel
        ColumnLayout {
            width: 360
            TextField {
                ...
                Accessible.name: qsTr("Local image asset identifier")
            }
            TextField {
                id: imageAlt
                Layout.fillWidth: true
